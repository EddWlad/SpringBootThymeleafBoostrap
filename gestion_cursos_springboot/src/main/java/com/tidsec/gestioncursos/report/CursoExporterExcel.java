...
public class CursoExporterExcel
{
    ...
    private void WriteDataLines()
    {
        ...
        for(Curso curso:cursos)
        {
            ...
            createCell(row,columnCount++, String.valueOf(curso.getId()),style);
            createCell(row,columnCount++,curso.getTitulo(),style);
            createCell(row,columnCount++,curso.getDescripcion(),style);
            createCell(row,columnCount++, String.valueOf(curso.getNivel()),style);
            createCell(row,columnCount++, String.valueOf(curso.isPublicado()),style);
        }
    }
